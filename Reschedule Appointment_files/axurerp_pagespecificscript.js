...
var PageName = 'Reschedule Appointment';
var PageId = 'p93c884fd3e2f462194e154ebc89e63b2'
...
u2based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> Pick a Dr.<BR><BR></div>");
...
u0based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> Pick a date<BR><BR></div>");
...
x = 0;
y = 0;
u1ann.insertAdjacentHTML("afterBegin", "<div id='u1Note' class='annnoteimage' style='left:" + x + ";top:" + y + "' onclick=\"ToggleWorkflow(event, 'u1', 300, 300, false)\"></div>");

eval(annwindow.replace(/\[\[id\]\]/g, 'u1').replace(/\[\[label\]\]/g, '?'));

document.body.insertAdjacentHTML("afterBegin", "<div id='u1based' style='z-index:1; visibility:hidden; position:absolute'></div><div id='u1base' style='z-index:1; visibility:hidden; position:absolute'></div>");
var u1based = document.getElementById('u1based');
            
u1based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> Pick a time<BR><BR></div>");
