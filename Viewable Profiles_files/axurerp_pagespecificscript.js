...
var PageName = 'Viewable Profiles';
var PageId = 'p8655e11e91e24b42b9c986d91eb1d792'
document.title = 'Viewable Profiles';
...
u19based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> In final product each session would be a link<BR><BR></div>");
...
if (true) {
	...
	self.location.href="Previous Session.html" + GetQuerystring();
