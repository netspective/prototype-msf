...
var PageName = 'Patient Blog Posts';
var PageId = 'p754b0d16a23340a7b3f87cce6a97468b'
document.title = 'Patient Blog Posts';
...
if (true) {
	...
	self.location.href="New Comment.html" + GetQuerystring();
...
u5based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> The currently logged in counseler's name is shown and this is a quick menu to select other actions.<BR><BR></div>");
