...
var PageName = 'Counselor Welcome to MyStressFree';
var PageId = 'p0adde661b3fa427b8d944a44d74f155e'
document.title = 'Counselor Welcome to MyStressFree';
...
u14based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> Lists past clients &amp; links to profile<br><BR><BR></div>");
...
if (true) {
	...
	self.location.href="Ignored Question Counselor Welcome to MyStressFree.html" + GetQuerystring();
...
u37based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> multiple clients<BR><BR></div>");
...
if (true) {
	...
	self.location.href="Chat Room.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Answer Question.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Current Session.html" + GetQuerystring();
...
u23based.insertAdjacentHTML("beforeEnd", "<div class='anncontent'><span class='annfieldname'>Specification:</span> Boxes dynamically adjust in height as more, and more information is sent into them<BR><BR></div>");
