...
function GetDynamicPanelScript(dpId, numberStates) {
    ...
    for (var i = 0; i < numberStates; i++) {
        s = s + "document.getElementById(\"pd" + i + dpId + "\").style.visibility = visibility; document.getElementById(\"pd" + i + dpId + "NoteContainer\").style.visibility = visibility;";
    }
    s = s + "} else { currentState" + dpId + ".style.visibility = visibility; document.getElementById(currentState" + dpId + ".id + \"NoteContainer\").style.visibility = visibility; } } ";
    
    s = s + "function SetPanelState" + dpId + "(stateid) {	SetPanelVisibility" + dpId + "(\"hidden\");	document.getElementById(\"" + dpId + "\").style.visibility = \"\";	currentState" + dpId + " = document.getElementById(stateid); currentState" + dpId + ".style.visibility = \"\"; document.getElementById(stateid + \"NoteContainer\").style.visibility = \"\"; }";
